...
if ($w == "") {
    ...
    */
	...
	//200513추가
	// $member['mb_GA']          = get_text($member['mb_GA']);
    // $member['mb_office']      = get_text($member['mb_office']);
    // $member['mb_sido']        = get_text($member['mb_sido']);
    // $member['mb_sigungu']     = get_text($member['mb_sigungu']);
    // $member['mb_position']    = get_text($member['mb_position']);
	//
