...
class PdoOne
{
     ...
     */
    var $masks0=array(2,0,4,5);
    var $masks1=array(16,13,12,11);
    ...
    private function objectExist($objectName,$type='table') {
        ...
        $arr=$this->runRawQuery($query,array(PDO::PARAM_STR,$objectName),true);
        return is_array($arr);
    }
     ...
     * @throws Exception
     */
    public function insertObject($table,$object,$excludeColumn=array()) {
        $tabledef=array();
