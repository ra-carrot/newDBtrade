...
<div id="mb_login" class="mbskin">
    ...
    <div class="mbskin_box">
		<div class="leftArea"><span>글로벌 DB<br>판매관리시스템</span></div> 
        <h1><?php echo $g5['title'] ?></h1>
        <form class="loginForm" name="flogin" action="<?php echo $login_action_url ?>" onsubmit="return flogin_submit(this);" method="post">
        ...
        <fieldset id="login_fs">
			...
			<div class="login_if_auto chk_box" style="text-align: left";>
