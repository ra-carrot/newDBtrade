...
<div class="register">
	...
	<fieldset class="memeberType" style="text-align: center; padding-bottom:15px;">
		<input type="radio" name="partner" id="common" value="common"/>
		<label for="common" style="margin-bottom:0px;">일반회원</label>
		<input type="radio" name="partner" id="partner" value="partner" checked/> 
		<label for="partner" style="margin-bottom:0px;">사원회원(사원코드가 필요합니다.)</label>
	</fieldset>
